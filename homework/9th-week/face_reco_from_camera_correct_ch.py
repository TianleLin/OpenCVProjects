...
import os
import time
from PIL import Image, ImageDraw, ImageFont # Lin: added
...
class Face_Recognizer:
    ...
    def modify_name_camera_list(self):
        ...
        self.name_known_list[0] ='林天乐 2019091613019' # Lin: coneypo
            ...
            while stream.isOpened():
                ...
                if kk == ord('q'):
                    ...
                    if len(faces) != 0:
                        ...
                        # 8. 写名字 / Draw name
                        cvt_image = self.draw_name(img_rd)

                print("Faces in camera now:", self.name_camera_list, "\n")
                cv2.imshow("camera", cvt_image) # Lin: img_rd to img
